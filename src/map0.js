...
export const Map0 = ({ shockwaveOn }) => {
    ...
    return (
        ...
        <mesh castShadow geometry={nodes.Building1_1.geometry} material={glass} />
        <mesh castShadow geometry={nodes.Building1_2.geometry} material={white} />
        <mesh castShadow geometry={nodes.Building1_3.geometry} material={beige} />
        <mesh castShadow geometry={nodes.Building1_4.geometry} material={concrete_1} />
        <mesh castShadow geometry={nodes.Building1_5.geometry} material={concrete_0} />
        <mesh castShadow geometry={nodes.Building1_6.geometry} material={wall_0} />
      </group>
      <group position={[-12.73, 0.67, 0.61]} rotation={[0, Math.PI / 2, 0]} scale={[3.09, 1.18, 2.8]}>
        <mesh castShadow geometry={nodes.Building2_1.geometry} material={wall_1} />
        <mesh castShadow geometry={nodes.Building2_2.geometry} material={glass} />
        <mesh castShadow geometry={nodes.Building2_3.geometry} material={white} />
        <mesh castShadow geometry={nodes.Building2_4.geometry} material={wall_1A} />
      </group>
      <mesh castShadow geometry={nodes.Fence.geometry} material={wood} position={[0, 0.47, 0]} />
      <mesh castShadow geometry={nodes.Mesh001.geometry} material={concrete_0} />
      <mesh castShadow geometry={nodes.Mesh001_1.geometry} material={sand_0} />
      <mesh castShadow geometry={nodes.Mesh001_2.geometry} material={sand_1} />
      <mesh castShadow geometry={nodes.Mesh001_3.geometry} material={alley} />
      <mesh geometry={nodes.Mesh001_4.geometry} material={grass_0} receiveShadow />
      <mesh geometry={nodes.Mesh001_5.geometry} material={grass_1} receiveShadow />
      <mesh geometry={nodes.Mesh001_6.geometry} material={grass_2} receiveShadow />
      <mesh castShadow
      ...
      <mesh castShadow
        ...
        scale={[0.36, 0.36, 0.36]}
      />
      <mesh castShadow geometry={nodes.Icosphere005.geometry} material={leaves_1} />
      <mesh castShadow
      ...
      <group position={[-5.86, 0.84, -5.27]} rotation={[-2.46, 0.41, -2.48]} scale={[0.53, 0.53, 0.53]}>
        <mesh castShadow geometry={nodes.Icosphere008_1.geometry} material={wood} />
        <mesh castShadow geometry={nodes.Icosphere008_2.geometry} material={leaves_2} />
        <mesh castShadow geometry={nodes.Icosphere008_3.geometry} material={leaves_3} />
      </group>
      ...
      <group position={[-10.53, 1.3, 12.72]} rotation={[-Math.PI, 0, -Math.PI]} scale={[3.56, 1.37, 2.01]}>
        <mesh castShadow geometry={nodes.Shop_1.geometry} material={white} />
        <mesh castShadow geometry={nodes.Shop_2.geometry} material={wall_3} />
        <mesh castShadow geometry={nodes.Shop_3.geometry} material={wall_0} />
        <mesh castShadow geometry={nodes.Shop_4.geometry} material={wall_4} />
        <mesh castShadow geometry={nodes.Shop_5.geometry} material={glass} />
        <mesh castShadow geometry={nodes.Shop_6.geometry} material={wall_concrete} />
      </group>
      <group position={[-2.07, 5.61, -13.71]} rotation={[-2.99, 0.2, -2.34]} scale={[0.35, 0.35, 0.35]}>
        <mesh castShadow geometry={nodes.Tree0_1.geometry} material={leaves_Dark_0}/>
        <mesh castShadow geometry={nodes.Tree0_2.geometry} material={leaves_0}/>
        <mesh castShadow geometry={nodes.Tree0_3.geometry} material={wood}/>
      </group>
      <group position={[-9.92, 5.91, -4.69]} rotation={[-0.16, 0.4, 0.9]} scale={[0.37, 0.37, 0.37]}>
        <mesh castShadow geometry={nodes.Tree1_1.geometry} material={leaves_0}/>
        <mesh castShadow geometry={nodes.Tree1_2.geometry} material={leaves_Dark_0}/>
        <mesh castShadow geometry={nodes.Tree1_3.geometry} material={wood}/>
      </group>
      <group position={[-7.36, 6.53, -14.9]} rotation={[-0.88, -1.37, -0.03]} scale={[0.38, 0.38, 0.38]}>
        <mesh castShadow geometry={nodes.TreeDark_1.geometry} material={leaves_1}/>
        <mesh castShadow geometry={nodes.TreeDark_2.geometry} material={wood}/>
        <mesh castShadow geometry={nodes.TreeDark_3.geometry} material={leaves_Dark_1}/>
      </group>
        </group>
    )
}
